...
public class AuthorizationConverter {
  ...
  public static List<UserRoleEntity> convertAuthorizationPostReqToEntityList(
      AuthorizationPostReq req) {
    List<UserRoleEntity> result = new ArrayList<>();
    req.getAuthorizationList()
        .forEach(
            authorization -> {
  ...
  public static AuthorizationPostRes convertEntityListToAuthorizationPostRes(
      List<UserRoleEntity> entityList) {
